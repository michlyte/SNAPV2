...
export default class NotificationsNew extends PureComponent {
    ...
    _onPressItem = (item, index, value) => {
        ...
        console.log("Item[BEFORE] - Item: " + newData[index].title + ", value: " + newData[index].value);
        newData[index].value = value;
        this.setState({
            data: newData
        });
        console.log("Item[AFTER] - Item: " + newData[index].title + ", value: " + newData[index].value);
    };
